...
export default function Sidebar({ sidebarOpen, setSidebarOpen, mounted } : SidebarProps) {
    ...
    <div>
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          {/* logo of the website */}
          <div className="w-32 h-8 bg-linear-to-r from-blue-600 to-purple-600 rounded-lg animate-pulse" />
          <button
              ...
              {filteredRoutes.slice(0, 8).map((route, index) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      size={16}
                      className="text-gray-500 group-hover:text-blue-500 transition-colors shrink-0"
                    />
