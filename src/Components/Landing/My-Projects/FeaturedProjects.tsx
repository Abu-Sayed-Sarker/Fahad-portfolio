    ...
    <section id="projects" className="px-6 py-16">
      ...
      {!loadingData && !error && hasMore && (
        <div className="flex justify-center mt-14">
          ...
          <a
            href="https://github.com/iaf12"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center px-6 py-4 gap-2 bg-linear-to-r from-[#6d28d9] to-[#a855f7] rounded-2xl text-white font-bold hover:opacity-90 transition-all shadow-[0_15px_35px_rgba(139,77,255,0.4)] hover:shadow-[0_20px_45px_rgba(139,77,255,0.6)] hover:-translate-y-1 text-center"
          >
            <Github size={18} />
            View all projects
          </a>
