        ...
        <div className="flex items-center justify-between h-20">
          <div className="shrink-0 cursor-pointer group">
            <a href="#home" className="relative">
              ...
              <img src={logo} alt="Istiaq Ahmmed Fahad Logo" loading="lazy" className="relative h-12 drop-shadow-[0_0_8px_rgba(124,58,237,0.3)]" />
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href={resume} download="Resume_Istiaq_Ahmmed_Fahad.pdf" className="px-6 py-2 border border-white/20 rounded-full text-white/90 bg-white/5 hover:bg-white/10 hover:border-[#7c3aed]/50 hover:shadow-[0_0_15px_rgba(124,58,237,0.2)] transition-all flex items-center gap-2">
          ...
          <div className="md:hidden">
            <button className="text-foreground" aria-label="Toggle navigation menu">
